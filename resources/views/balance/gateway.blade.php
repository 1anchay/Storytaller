        ...
        <div class="p-8">
            ...
            <div class="bg-gray-700 rounded-lg p-6 mb-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-xl font-bold text-amber-400">{{ number_format($amount, 2) }} ₽</span>
                </div>
                <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Баланс после пополнения:</span>
                    <span class="text-xl font-bold text-green-400">
                        {{ number_format(auth()->user()->balance + $amount, 2) }} ₽
                    </span>
                </div>
            </div>
