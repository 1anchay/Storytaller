  ...
  <div class="max-w-7xl mx-auto px-6">
    <div class="flex justify-between items-center py-4">
      ...
      <nav class="hidden md:flex items-center space-x-1">
        ...
        <a href="{{ route('store') }}" class="px-4 py-2 rounded-md font-medium flex items-center space-x-2 hover:bg-gray-700/50 hover:text-purple-300 transition-all duration-200 group">
    ...
    <div id="mobile-menu" class="hidden md:hidden pb-4">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        <a href="{{ route('home') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700/50 hover:text-indigo-300 flex items-center space-x-2">
        ...
        <a href="{{ route('home') }}" class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700/50 hover:text-purple-300 flex items-center space-x-2">
